defmodule Manto.Content.ParserPluginsTest do
  ...
  test "render_html with TOC plugin enabled — TOC appears in output HTML" do
    ...
    assert html =~ ~s(<h1 id="my-page">My Page<a href="#my-page">)
    assert html =~ ~s(<h2 id="section-one">Section One<a href="#section-one">)
  end
  ...
  test "render_html with no plugins enabled — output unchanged" do
    ...
    assert html =~ ~s(<h1 id="just-a-heading">Just a heading<a href="#just-a-heading">)
